const About = () => {
    return (
      <section className="py-20" style={{ backgroundColor: '#005883' }}>
        ...
        Our mission is simple: to bring your ideas to life through powerful, engaging, and well-crafted content. Whether you're a business looking to enhance your brand voice or a creator in need of fresh ideas, we've got you covered.
